...
# Traning DATA df -------------------------------------------------------------------------------------
df=pd.read_csv("C:/Users/ba861/PycharmProjects/PythonProject/DiseaseDetection/Training.csv")
...
# Testing DATA tr --------------------------------------------------------------------------------
tr=pd.read_csv("C:/Users/ba861/PycharmProjects/PythonProject/DiseaseDetection/Testing.csv")
...
def DecisionTree():
    ...
    print("\nDECISION TREE")
    print("Accuracy Score in fraction of correctly classified samples:",accuracy_score(y_test, y_pred))
    print("Accuracy Score in number of correctly classified samples:",accuracy_score(y_test, y_pred,normalize=False))
...
w2 = Label(root, justify=LEFT, text="Project by Narsimha Rampally", fg="black", bg="white")
w2.config(font=("Aharon", 30))
...
lrLb = Label(root, text="Disease predicted by DecisionTree:-", fg="white", bg="green")
lrLb.grid(row=15, column=0, pady=10,sticky=W)

destreeLb = Label(root, text="Disease predicted by RandomForest:-", fg="white", bg="green")
destreeLb.grid(row=17, column=0, pady=10, sticky=W)

ranfLb = Label(root, text="Disease predicted by NaiveBayes:-", fg="white", bg="green")
